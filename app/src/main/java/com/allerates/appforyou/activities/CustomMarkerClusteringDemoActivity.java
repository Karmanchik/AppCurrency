...
import com.allerates.appforyou.model.Person;
import com.allerates.appforyou.utils.MultiDrawable;
...
public class CustomMarkerClusteringDemoActivity extends BaseDemoActivity implements ClusterManager.OnClusterClickListener<Person>, ClusterManager.OnClusterInfoWindowClickListener<Person>, ClusterManager.OnClusterItemClickListener<Person>, ClusterManager.OnClusterItemInfoWindowClickListener<Person> {
    ...
    private class PersonRenderer extends DefaultClusterRenderer<Person> {
        ...
        protected void onBeforeClusterRendered(Cluster<Person> cluster, MarkerOptions markerOptions) {
            ...
            // Note: this trimLastCharacter runs on the UI thread. Don't spend too much time in here (like in this example).
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(CustomMarkerClusteringDemoActivity.this, MainActivity.class);

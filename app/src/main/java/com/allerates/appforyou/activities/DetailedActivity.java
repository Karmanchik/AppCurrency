...
public class DetailedActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    @BindView(R.id.tv_currency2) TextView minOrder;
    @BindView(R.id.tv_address) TextView tvAddress;
    @BindView(R.id.tv_work_time) TextView tvWorkTime;
    @BindView(R.id.tv_currency) TextView tvPayMeth;
    @BindView(R.id.tv_about) TextView tvAbout;
    @BindView(R.id.add_commend) ImageView imgAdd;
    @BindString(R.string.txt_error_colon) String txtErrorColon;
    @BindView(R.id.lnr_comment) LinearLayout lnrComment;

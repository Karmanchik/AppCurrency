...
/**
 * Created by Rikmen on 25.06.2018.
 */
...
public class PlaceAutocompleteAdapter
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            //Login.i(TAG, "Query completed. Received " + autocompletePredictions.getCount()
            //           + " predictions.");
//
        ...
        //Login.e(TAG, "Google API client is not connected for autocomplete query.");
        return null;
    }
